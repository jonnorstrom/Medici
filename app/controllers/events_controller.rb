class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:name, :blurb, :transportation_info, :address, :website, :description, :photo, :opening_time, :closing_time, :start_date, :price, :end_date, :museum_id, :ticketable, :tag_ids => [])
  end
end
